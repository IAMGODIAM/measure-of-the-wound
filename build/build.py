...
<section class="abstract-page">
  ...
  <p class="abs">This paper assembles an eight-pillar empirical record of Black American structural disparity across the era of formal legal equality, 1991&ndash;2024, nested within federal series that reach to 1900 (health), 1925 (criminal justice), 1940 (housing), 1964 (political participation), 1972 (labor) and 1514 (the historical architecture). Drawing on approximately 14,811 raw observations from the Bureau of Labor Statistics, the Census Bureau, the National Center for Health Statistics, the Bureau of Justice Statistics, the Federal Reserve, the National Center for Education Statistics, the Consumer Financial Protection Bureau, the Department of Agriculture and the Slave Voyages Database, synthesized into 1,574 verified observations, with the organization&rsquo;s exploratory place-level index scoring 15,507 census tracts in 49 cities, it documents a consistent pattern: absolute conditions improve while the ratio between Black and white outcomes holds or widens. The instruments are descriptive: they document ratios, gaps and co-occurrence across time and place, and do not identify or test the causal mechanisms behind them. In constant 2022 dollars, Black median family wealth rose 388 percent while the absolute wealth gap reached its widest point in the survey&rsquo;s history. The Black/white unemployment ratio has never inverted in fifty-four years. The maternal mortality ratio is higher in 2022 (2.61) than in 1933 (1.77). The imprisonment ratio moved 1.03 points across ninety-seven years. The homeownership gap is wider than when the Fair Housing Act was signed. The paper reports the organization&rsquo;s exploratory place-level composite index &mdash; its scores are published outputs, not independently verified results &mdash;, prints its full corrections ledger as an appendix, publishes an independent verification review and the author&rsquo;s reply alongside the release, and places all data and code in the public domain under CC0.</p>
  <p class="abs-meta"><strong>Keywords:</strong> racial inequality; wealth gap; structural racism; Black Americans; longitudinal federal data; exploratory composite index; maternal mortality; incarceration; homeownership; open data</p>
...
head=("<meta charset='utf-8'><title>The Measure of the Wound</title>"
      ...
      "<meta name='keywords' content='racial inequality, wealth gap, structural racism, Black Americans, longitudinal federal data, exploratory composite index, maternal mortality, incarceration, homeownership, open data'>"
