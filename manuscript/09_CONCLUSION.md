...
**On health.** In 2021, Black women in America died in childbirth at 69.9 per 100,000 live births — a rate the World Health Organization associates with low-income nations. And the ratio that matters most in this dataset: in 1933, the first year of complete national reporting, under legal Jim Crow and in segregated hospitals, a Black woman died in childbirth 1.77 times as often as a white woman. In 2022, she died 2.61 times as often. Eighty-nine years of modern medicine coincided with the disparity widening by a factor of 1.47. Between 2019 and 2021, Black life expectancy fell four full years, to a level last seen in the mid-1990s.

**On criminal justice.** In 1925, Black males were imprisoned at 6.45 times the white male rate. In 2022, at 5.42 times. The series measures male imprisonment rates per 100,000 same-race male residents (basis established v1.4.4; BJS's all-adults 2022 ratio is 5.22). The ratio moved 1.03 points in ninety-seven years, across two world wars, the Civil Rights Act, the Voting Rights Act, mass incarceration's rise and a genuine 47 percent decarceration from its peak. From 2013 to 2023, 3,496 Black Americans were killed by police; 397 were unarmed.
...
This is the paper's reading of the sequence the series support — asserted as interpretation, not tested as mechanism: a crisis is documented; public pressure builds; a law is passed or a program funded; enforcement infrastructure is underfunded and deprioritized; the metric improves in absolute terms — sometimes dramatically — while the ratio between Black and white outcomes holds or widens; the absolute improvement is reported as progress; political energy dissipates; the structure continues. The series establish the bookends — the persistence of the ratios. The steps between are the author's account of the historical record around them.

This is not policy failure in the ordinary sense. Failure implies the intended outcome was not achieved. But the maternal mortality series makes the sharper reading the paper's explicit interpretation: absolute performance improved by a factor of twenty while the disparity ratio grew by a factor of 1.47. A system can improve enormously and distribute the improvement unequally, and this paper reads eighty-nine years of that consistency as a property of the system doing the improving — not an accident of the improvement. That reading is asserted as interpretation; the ratios document the consistency, not the property.

This is a claim about function — offered as the paper's interpretive frame, not its measurement. Systems are judged by what they produce. What this one has produced, measured across fifty-four years of labor data, ninety-seven years of incarceration data and one hundred and twenty-two years of mortality data, is a set of ratios more durable than every legal remedy written, in its own era, to narrow them.

Ralph McCartney understood this from inside the geography. *"They have their plans set decades and scores in advance."* He was not speaking metaphorically. The redlining maps confirm it. The urban renewal records confirm it. This paper documents the resulting conditions at national scale across eight dimensions — the persistence is the finding; the ratios do not establish the planning.
...
It documents what the system has done, where, and with what consistency. It reports the places where the organization's exploratory instrument places the compound weight of every pillar simultaneously — Humphreys, Claiborne, Sunflower, Amite, Alexander — naming them by what the instrument's published outputs say rather than by what would have been more familiar to name. Those placements are the organization's outputs, not verified findings; they are reported here, not established.
...
We print it because the alternative is a record that invites scrutiny it has not performed on itself. Every number in this paper can be checked against a public federal source or a public repository — except the FDI composite outputs, which are the exception this paper discloses rather than hides: they are the organization's published outputs, and their arithmetic cannot yet be rebuilt from the published package. Inviting scrutiny of everything else and concealing that finding would be incoherent.
