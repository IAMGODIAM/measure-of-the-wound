...
**Repository (tract):** `farmblock-data` — 15,507 census tracts, 49 cities
...
|-------|-------------|--------|
| Tracts scored (FDI v2.0) | **15,507** | `processed/farmblock_fdi_v2.csv` row count, re-verified August 2026 (supersedes 15,578) |
| Cities ranked (FDI v2.0) | **49** | `processed/farmblock_city_rankings.csv` row count, re-verified August 2026 (supersedes 50) |
