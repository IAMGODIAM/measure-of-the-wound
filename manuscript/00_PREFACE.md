...
This paper corrects that. The dataset underlying it is CC0, public domain. Every table, every trend line, every compound score, every city in the analysis belongs to anyone who can use it: the community organizer building a grant application, the attorney preparing a fair housing complaint, the journalist writing about the Delta, the student at an HBCU whose library cannot afford the journal that published the study she needs. There is no request form. There is no fee. There are no restrictions. It is yours.
